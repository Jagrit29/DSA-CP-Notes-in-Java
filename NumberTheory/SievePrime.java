...
public class Main {
	public static void main(String[] args) {
		...
		// I will construct sieve for all the primes from 1 to 10^9;
		int N = (int)Math.pow(10,8);
		boolean primes[] = new boolean[N];

		// If prime[i] == true, its prime;

		Arrays.fill(primes,false); //Making everything non prime;

		// 2 is prime;
		primes[1]=false;
		primes[2]=true;

		// I need to make all odd numbers true;
		for(int i=3;i<N;i=i+2)
		{
			primes[i] = true;
		}

		//Now I will apply sieve;

		for(int i=2;i<Math.sqrt(N);i++)
		{
			if(primes[i]==true)
			{
				//Now I need to make all the multiples of i false;
